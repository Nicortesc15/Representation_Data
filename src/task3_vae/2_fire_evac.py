...
train_loader = DataLoader(torch.tensor(train_dataset_scaled, dtype=torch.float32), batch_size=64, shuffle=False)
...
test_loader = DataLoader(torch.tensor(test_dataset_scaled, dtype=torch.float32), batch_size=64, shuffle=False)
...
plots_at_epochs = []  # generate plots at epoch numbers
